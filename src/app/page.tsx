            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-16 items-center">
              <div className="flex flex-col justify-center space-y-6 animate-fade-in-up">
                ...
                <div className="flex flex-col gap-4 min-[400px]:flex-row pt-4">
                  <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground glow-effect text-lg px-8 py-6">
                    <Link href="/contact">Get a Free Quote</Link>
                  </Button>
                  <Button asChild size="lg" variant="outline" className="glow-effect text-lg px-8 py-6">
